<div align="center">
  <img src="assets/mirothinker_logo.png" width="55%" alt="OpenClaw-MiroSearch" />
</div>
...
**OpenClaw-MiroSearch** is an open-source research/search agent project focused on improving retrieval quality and controllable cost for agents (including OpenClaw scenarios). It keeps compatibility with existing search channels such as **SearXNG / SerpAPI / Serper** and continues to support multi-provider routing.

## 🧭 Project Positioning

- **Project Name**: OpenClaw-MiroSearch
- **Purpose**: Solve practical search-tool issues for agent systems (cost, stability, multi-source retrieval quality).
- **Compatibility**: Supports SearXNG, SerpAPI, Serper, and keeps compatibility with the existing MiroFlow toolchain.
- **Open-Source Attribution**: This project is adapted from [MiroThinker](https://github.com/MiroMindAI/MiroThinker) by **MiroMindAI**, with additional engineering modifications for OpenClaw-oriented retrieval workflows.

See [OPEN_SOURCE_ATTRIBUTION.md](OPEN_SOURCE_ATTRIBUTION.md) for attribution details.
